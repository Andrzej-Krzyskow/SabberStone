...
Beam Search --- uproszczenie przeszukiwania wszerz, zachowujące tylko $k$ najbardziej obiecujących ścieżek --- pojawił się w edycji 2019 w agencie Bokelmanna i Unkringa oraz w edycji 2020 w agencie Ortlama. Pokrewnym podejściem jest BFS stosowane przez Heberta i Hecka w edycji 2019. Podejścia te redukują złożoność pamięciową przeszukiwania kosztem utraty gwarancji optymalności~\cite{hearthstone_competition}.
