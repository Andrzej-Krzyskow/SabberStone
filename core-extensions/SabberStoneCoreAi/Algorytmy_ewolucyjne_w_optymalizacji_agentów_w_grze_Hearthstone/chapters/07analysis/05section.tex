...
Rysunek~\ref{fig:shade-tuning-conv} pokazuje szybkie wypłaszczenie krzywych fitness na trzech różnych poziomach. To naturalny efekt różnych skal ewaluacji dla \(\texttt{POP\_SIZE}=5/10/15\) --- każda konfiguracja miała inną liczbę przeciwników, więc wysokości krzywych nie należy porównywać wprost między sobą. W każdej konfiguracji największy przyrost pojawia się na początku, a późniejsze zmiany są małe. Wolniejszą stabilizację widać głównie dla wariantu HoF-10.
