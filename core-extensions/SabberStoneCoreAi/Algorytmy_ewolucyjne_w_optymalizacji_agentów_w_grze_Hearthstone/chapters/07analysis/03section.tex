...
Faza II potwierdza też praktyczny sukces całego podejścia badawczego --- zaproponowane modyfikacje (poza wariantem \textit{63 parametry}) przewyższają wariant bazowy, a najlepszy wariant ma przewagę nad każdym rywalem. Nie są to więc wyłącznie teoretyczne i formalne zmiany.
...
Bardzo mała rola \textit{Ręka} jest spójna z praktyką gry --- w tym zbiorze talii i przy tym stylu oceny większy wpływ ma bieżący stan stołu, tempo rozgrywki i aktywne synergie niż sama liczba kart na ręce. Model premiuje dobrą sytuację na planszy niż zapas kart, dlatego waga \textit{Ręka} spada blisko zera.
