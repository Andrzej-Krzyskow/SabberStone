...
Tabela \ref{tab:phase1-representatives} pokazuje dwie rzeczy. SHADE koewolucyjny był najskuteczniejszy dla pięciu z sześciu wariantów, więc wygląda na dobrze dopasowany do większości badanych konfiguracji. Z kolei dla wariantu głębokościowego lepszy wynik uzyskał z kolei SHADE z Hall of Fame --- najpewniej dlatego, że bardziej zróżnicowany zbiór przeciwników ma tu większe znaczenie.
