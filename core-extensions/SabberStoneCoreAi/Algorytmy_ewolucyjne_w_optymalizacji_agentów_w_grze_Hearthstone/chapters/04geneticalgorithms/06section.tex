...
Jednym z pierwszych powszechnie przyjętych rozwiązań problemu doboru parametrów sterujących DE był algorytm JADE (ang. \textit{Joint Approximation Diagonalization of Eigen-matrices}). Został on zaproponowany przez Zhanga i Sandersona \cite{Zhang2009JADE} i wprowadza strategię mutacji \texttt{DE/current-to-pbest/1}:
\[
