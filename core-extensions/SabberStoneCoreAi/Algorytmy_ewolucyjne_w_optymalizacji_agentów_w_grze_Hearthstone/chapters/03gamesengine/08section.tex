...
SabberStone stanowi rozwinięte i wszechstronne środowisko badawcze, pokrywające potrzeby eksperymentalne na wielu poziomach --- od szybkiego prototypowania algorytmów, przez organizację formalnych turniejów, aż po integrację z zewnętrznymi systemami uczenia maszynowego. Tabela~\ref{tab:sabber_summary} zestawia kluczowe możliwości silnika z perspektywy zastosowań naukowych.
