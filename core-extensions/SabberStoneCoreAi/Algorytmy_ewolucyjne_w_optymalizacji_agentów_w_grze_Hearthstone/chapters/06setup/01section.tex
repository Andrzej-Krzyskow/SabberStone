...
\begin{equation}
    ...
    \label{eq:greedy}
\end{equation}
gdzie $\mathcal{A}(s)$ oznacza zbiór wszystkich dostępnych akcji dostępnych
...
\begin{equation}
    ...
    \label{eq:delta_mana}
\end{equation}
gdzie $\text{mana}^{\text{rem}}$ oznacza pozostałą ilość many gracza. Składnik ten jest \emph{odejmowany} w równaniu~\eqref{eq:score}, karząc akcje o wysokim koszcie many.
