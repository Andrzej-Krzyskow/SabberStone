...
Niniejsza sekcja opisuje sprzęt, konfigurację parametrów oraz talie użyte we wszystkich eksperymentach. Opisana konfiguracja stanowi punkt odniesienia dla porównań między wariantami opisanymi w kolejnych sekcjach.
...
\hspace{1em}28 params        & koewolucja & 3 & 27,71 \\
\hspace{1em}28 params norm   & koewolucja & 3 & 29,71 \\
\hspace{1em}63 params        & koewolucja & 3 & 27,09 \\
\hspace{1em}63 params smooth & koewolucja & 3 & 26,86 \\
\hspace{1em}21 depth         & koewolucja & 1 & 34.51 \\
\midrule
...
\midrule
\multicolumn{4}{l}{\textit{Testy SHADE na agencie 21 params}} \\
\hspace{1em}21 params        & SHADE koew.  & 1 & 8.89 \\
\hspace{1em}21 params        & SHADE HoF    & 1 & 9.70 \\
\midrule
\multicolumn{4}{l}{\textit{Warianty SHADE koewolucyjnego (POP\_SIZE = 15)}} \\
\hspace{1em}28 params        & SHADE koew. & 3 & 27,81 \\
\hspace{1em}28 params norm   & SHADE koew. & 3 & 29,37 \\
\hspace{1em}63 params        & SHADE koew. & 3 & 26,57 \\
\hspace{1em}63 params smooth & SHADE koew. & 3 & 26,42 \\
\hspace{1em}21 depth         & SHADE koew. & 1 & 30.21 \\
\midrule
\multicolumn{4}{l}{\textit{Warianty SHADE z Hall of Fame (POP\_SIZE = 15)}} \\
\hspace{1em}28 params        & SHADE HoF & 3 & 30.36 \\
\hspace{1em}28 params norm   & SHADE HoF & 3 & 31.78 \\
\hspace{1em}63 params        & SHADE HoF & 3 & 29.41 \\
\hspace{1em}63 params smooth & SHADE HoF & 3 & 29.47 \\
\hspace{1em}21 depth         & SHADE HoF & 1 & 34.62 \\
\midrule
...
Eksperymenty prowadzono z użyciem trzech talii stosowanych w oryginalnym badaniu~\cite{sanchez2020}. Każda para agentów rozgrywa partie we wszystkich dziewięciu kombinacjach talii ($3 \times 3$), co zapewnia ocenę odporną na specyfikę konkretnej talii. Pełny skład talii przedstawia tabela \ref{tab:decklists}.

\paragraph{RenoKazakusMage --- klasa Mag.}
Talia kontrolna oparta na unikalnej mechanice Kazakusa: każda karta w talii jest unikalna, nie ma swoich duplikatów, co aktywuje zdolność Reno Jacksona, czyli pełne leczenie bohatera. Strategia polega na przeżyciu wczesnej gry, uniemożliwieniu przeciwnikowi rozbudowy planszy i wygraniu poprzez silne zaklęcia w późnej fazie. Talia faworyzuje agentów zarządzających zasobami kosztem agresywnych strategii.

\paragraph{MidrangeJadeShaman --- klasa Szaman.}
Talia midrange oparta na mechanice Jade Golem --- każdy kolejny przywołany golem ma o 1/1 więcej statystyk niż poprzedni. Strategia łączy wczesną kontrolę planszy z narastającą przewagą w fazie środkowej i końcowej. Mechanika ta wymaga od agenta uwzględnienia wartości stronników w horyzoncie wielu tur, a nie tylko aktualnego stanu planszy.
