...
def launch_simulator(f1, f2, d1, d2, thread_id):
	...
	if test:
		...
		command_line = r"dotnet run --project D:\Pics_Movies\vids\PWr\Sem10\magisterka\MODIFIED28NORMALIZED_PARALLEL_HS\SabberStone" + thread_id + r"\core-extensions\SabberStoneCoreAi\SabberStoneCoreAi.csproj"
